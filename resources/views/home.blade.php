...
<div id="container">
  <div class="slide anim-in">
    ...
    <div class="content">
      ...
      <ul class="city-info">
<<<<<<< HEAD
        <div class="arrow"><a href="{{route('streetart')}}">Accéder</a><img src="http://marcelklacan.com/images/icon.png" alt="" /></div>
=======
>>>>>>> origin/master
      </ul>
    </div>
  ...
  <div class="slide anim-in">
    ...
    <div class="content">
      ...
      <ul class="city-info">
        <div class="arrow"><a href="{{route('architecture')}}">Accéder</a><img src="http://marcelklacan.com/images/icon.png" alt="" /></div>
      </ul>
    </div>
    <div class="btn-close"></div>
  </div>
  <div class="slide anim-in">
    ...
    <div class="content">
      ...
      <ul class="city-info">
        <div class="arrow"><a href="{{route('perspective')}}">Accéder</a><img src="http://marcelklacan.com/images/icon.png" alt="" /></div>
      </ul>
    </div>
    <div class="btn-close"></div>
  </div>
  <div class="slide anim-in">
    ...
    <div class="content">
      ...
      <ul class="city-info">
        <div class="arrow"><a href="{{route('nature')}}">Accéder</a><img src="http://marcelklacan.com/images/icon.png" alt="" /></div>
      </ul>
    </div>
    <div class="btn-close"></div>
  </div>
